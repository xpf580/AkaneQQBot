...
@driver.on_startup
async def init_db():
    config.db = await aiosqlite.connect("src/static/Akane.db")
    logger.info("Akane -> Starting to Create \"Akane Database\"")
    try:
        ...
        logger.info("Akane -> Create \"Akane Database\" successfully")
    except Exception as e:
        logger.info(f"Akane --Skip-> Database Created....Skipped Creating Databases. \n[SKIP ERR]{e}")
        pass
